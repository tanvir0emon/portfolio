<template>
    ...
    <div class="" style="background: #FFFAEF">
        <div class="container ">
            <div class="information w-full lg:flex py-12 md:py-0 px-8">


                <!-- Content -->
                <div class="lg:w-2/3 w-full flex items-center">
                    <div class="">
                        <h1 class="text-3xl font-bold text-primary-500">Have A Project In your Mind ?</h1>
                ...
                <div class="lg:w-1/3 w-full flex justify-end">
                      <img src="/images/work.png" class="my-0 md:my-4 lg:my-6 h-70  mx-auto lg:mx-0 px-8" alt="">
                </div>
            </div>
        </div>
    </div>
